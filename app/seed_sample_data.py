...
PRIMARY_ALIAS_BY_TYPE: dict[BusinessType, str] = {
    ...
    BusinessType.hardware: "jengo-mega-hardware",
...
PRODUCT_CATALOG: dict[BusinessType, list[tuple[str, str, float, float, float, str]]] = {
    ...
    BusinessType.hardware: [
        ("Cement 50kg Dangote", "Building", 22000, 18500, 40, "bags"),
        ("Cement 50kg Twiga", "Building", 21500, 18200, 38, "bags"),
        ("Iron Sheet Gauge 28", "Roofing", 45000, 38000, 25, "sheets"),
        ("Iron Sheet Gauge 30", "Roofing", 42000, 35500, 30, "sheets"),
        ("PVC Pipe 2 inch", "Plumbing", 8500, 6000, 60, "pcs"),
        ("PVC Pipe 1 inch", "Plumbing", 5200, 3800, 80, "pcs"),
        ("PVC Elbow 2 inch", "Plumbing", 1800, 900, 120, "pcs"),
        ("Paint Emulsion 20L", "Paint", 85000, 62000, 15, "buckets"),
        ("Paint Gloss 4L", "Paint", 28000, 19000, 25, "cans"),
        ("Nails 3 inch 1kg", "Fasteners", 4500, 2800, 80, "kg"),
        ("Screws Assorted 500g", "Fasteners", 6500, 4200, 70, "packs"),
        ("Door Handle Set Chrome", "Door Hardware", 35000, 22000, 18, "sets"),
        ("Padlock 50mm Heavy", "Security", 18000, 11000, 35, "pcs"),
        ("Hinges 4 inch Pair", "Door Hardware", 8500, 5200, 45, "pairs"),
        ("Wheelbarrow Heavy Duty", "Tools", 185000, 135000, 12, "pcs"),
        ("Shovel Spade", "Tools", 28000, 16500, 25, "pcs"),
        ("Hammer Claw 500g", "Tools", 15000, 8500, 40, "pcs"),
        ("Measuring Tape 5m", "Tools", 12000, 6500, 55, "pcs"),
        ("Sand River 7 Tonne", "Aggregates", 420000, 350000, 8, "loads"),
        ("Gravel 7 Tonne", "Aggregates", 380000, 310000, 6, "loads"),
        ("Timber 2x4 12ft", "Timber", 18500, 12000, 90, "pcs"),
        ("Plywood 6mm 8x4", "Timber", 65000, 48000, 22, "sheets"),
        ("Roofing Nails 1kg", "Fasteners", 5200, 3100, 100, "kg"),
        ("Water Tank 500L", "Plumbing", 285000, 210000, 10, "pcs"),
        ("Tap Mixer Kitchen", "Plumbing", 45000, 28000, 20, "pcs"),
        ("Electrical Cable 2.5mm 100m", "Electrical", 125000, 88000, 15, "rolls"),
        ("Switch Socket Double", "Electrical", 8500, 4800, 60, "pcs"),
        ("LED Bulb 12W", "Electrical", 3500, 1800, 150, "pcs"),
        ("Tile Ceramic 40x40", "Finishing", 12000, 7500, 200, "sqm"),
        ("Tile Adhesive 20kg", "Finishing", 22000, 14500, 35, "bags"),
    ],
