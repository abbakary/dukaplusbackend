...
def _build_user_response(user: User) -> UserResponse:
    ...
    return UserResponse(
        ...
        subscription_expiry=tenant.subscription_expiry.isoformat()[:10] if tenant and tenant.subscription_expiry else None,
        tin_number=tenant.tin_number if tenant else None,
